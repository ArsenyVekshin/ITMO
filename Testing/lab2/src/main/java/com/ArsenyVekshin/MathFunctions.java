...
public class MathFunctions implements Cloneable{
    ...
    public void generateTestsCsv(String filename, java.util.function.Function<Double, Double> module, double start, double step, int count) throws IOException {
        try (BufferedWriter writer = new BufferedWriter(new FileWriter(new File(filename)))) {
...
/*        generateCsv(PATH + "sin.csv", this::sin, 0.0, 0.25, 10);
        ...
        generateCsv(PATH + "f.csv", this::f, -10, 0.1, 200);*/

        generateTestsCsv(PATH + "sin.csv", this::sin, 0.1, 0.25, 10);
        generateTestsCsv(PATH + "cos.csv", this::cos, 0.1, 0.25, 10);
        generateTestsCsv(PATH + "tan.csv", this::sin, this::cos, 0.1, 0.25, 10);
        generateTestsCsv(PATH + "cot.csv", this::tan, 0.1, 0.25, 10);
        generateTestsCsv(PATH + "sec.csv", this::cos, 0.1, 0.25, 10);
        generateTestsCsv(PATH + "csc.csv", this::sin, 0.1, 0.25, 10);

        generateTestsCsv(PATH + "log_2.csv", this::log_2, 1.0, 0.25, 10);
        generateTestsCsv(PATH + "log_3.csv", this::log_3, 1.0, 0.25, 10);
        generateTestsCsv(PATH + "log_5.csv", this::log_5, 1.0, 0.25, 10);
        generateTestsCsv(PATH + "log_10.csv", this::log_10, 1.0, 0.25, 10);
    }

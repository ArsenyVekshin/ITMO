...
# region Предобработка исходных данных
...
# region Визуализация исходных данных
desc = data.describe()
...
# region Логистическая регрессия
class LogisticRegression:
    def __init__(self, learning_rate=0.01, num_iterations=1000, fit_intercept=True, threshold=0.5,
...
# region Обучение модели и расчет метрик
...
# endregion Визуализация результатов

# region Визуализация результатов
...
for param in params:
    g = sns.catplot(x='optimization_method', y=param, hue='learning_rate', col='num_iterations', data=results_df,

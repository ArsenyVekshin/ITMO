...
X_train = train_data.drop('Performance Index', axis=1) # заменим целевой столбец на 1
y_train = train_data['Performance Index']
X_test = test_data.drop('Performance Index', axis=1) # заменим целевой столбец на 1
...
X_train_model_2 = X_train.drop('Hours Studied', axis=1) # заменим целевой столбец на 1
X_test_model_2 = X_test.drop('Hours Studied', axis=1) # заменим целевой столбец на 1
...
X_train_model_5["Study_Efficiency"] = X_train_model_5["Hours Studied"] * X_train_model_5["Previous Scores"]
X_test_model_5["Study_Efficiency"] = X_test_model_5["Hours Studied"] * X_test_model_5["Previous Scores"]

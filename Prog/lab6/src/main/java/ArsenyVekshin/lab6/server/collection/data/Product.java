...
import ArsenyVekshin.lab6.server.utils.validators.AutoGenerated;
import ArsenyVekshin.lab6.server.utils.validators.GreaterThan;
...
public class Product extends Entity implements Cloneable, CSVOperator {
    @AutoGenerated
    @NotNull
    @GreaterThan("0")
    ...
    public String generateCSV() {
        String out = id +
                ...
                ", " + price +
                ", " + unitOfMeasure + ", ";
                if(manufacturer != null)  out+= manufacturer.generateCSV();
                else out += null;
        return out;
    }
